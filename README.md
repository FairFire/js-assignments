...
## Javascript Assignments  [![Build Status](https://travis-ci.org/FairFire/js-assignments.svg?branch=master)](https://travis-ci.org/FairFire/js-assignments)
...
* Run `git clone https://github.com/FairFire/js-assignments.git` from command line to download the repo.
...
* Edit local README.md file and update all links (just replace all occurrences of `FairFire'` with your account name).
...
```
* Open https://github.com/FairFire/js-assignments and test the build icon. Now it will run all tests and update status once you push changes to github. Keep this icon green!
